  ...
  <body style="position:relative">
   ...
   <?php 
    ...
    if(isset($_GET['email']) && isset($_GET['reset_token']))
    {
        ...
        $date = date("Y-m-d");
        $query = "SELECT * FROM `fa` WHERE `email`='$_GET[email]' AND `resettoken`='$_GET[reset_token]' AND `resettokenexpire`='$date'";
...
{
  $pass=$_POST['password'];
  $update = "UPDATE `fa` SET `password`='$pass',`resettoken`=NULL,`resettokenexpire`=NULL WHERE `email`='$_POST[email]'";
