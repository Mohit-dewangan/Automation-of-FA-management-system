...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  $exists = false;
  if($exists == false){
    $sql =  "Select * from fa where username = '$username' AND password = '$password'";
...
<br><br>
<div class = "container">
<form action = "/FA/login.php" method = "post">
...
<img src="nitcl.png" class="card-img-top">
    ...
    <br>
  <div class="card-body">
    <h3 style="text-align:center">FA Login</h3>
    <br>
  <label for="username">Username</label>
    ...
    <a href="password_reset.php" class="float-end" name="reset_link" >Forget ur password?</a>
  </div>
  </div>
    </form>
    </div>
